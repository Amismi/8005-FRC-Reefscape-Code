...
public class Telemetry {
    ...
    ToolSubsystems m_ToolSubsystems = RobotContainer.m_ToolSubsystems;
    LimelightSubsystem m_LimelightSubsystem = RobotContainer.m_LimelightSubsystem;
    ...
    public void telemeterize(SwerveDriveState state) {
        ...
        SmartDashboard.putNumber("ElevatorPosition", m_ToolSubsystems.elevator.getPosition().getValueAsDouble());
        //martDashboard.putNumber("PivotPosition", LiftSubsystem.pivotEncoder.getPosition());
        SmartDashboard.putString("Current Pose", RobotContainer.drivetrain.getState().Pose.toString());
        SmartDashboard.putString("Current Limelight Pose", m_LimelightSubsystem.estimatePose.getEstimatedPosition().toString());
       ...
       // SmartDashboard.putNumber("Distance from apriltag", LimelightSubsystem.GetAprilTagDistance());
